...
\begin{entrylist}
	\entry
		...
		{Data Science}
		{Worked with a small team to create a model that predicts IMDB ratings, Rotten Tomatoes user and critic score, and Box Office performance of movies.
		{\vspace{-0mm}\begin{itemize}[noitemsep,nolistsep]
			\small
...
\begin{minipage}[t]{0.5\textwidth}
	...
	\boldwithparens{CI Tools}{Git, Jenkins}
